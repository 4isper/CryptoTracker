        ...
        Column(
            ...
            FlowRow(
                ...
                val  absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent42Hr.value / 100))
                        .toDisplayableNumber()
                val isPositive = coin.changePercent42Hr.value > 0.0
            ...
            AnimatedVisibility(
                ...
                Log.d("selectedDataPoint", "$selectedDataPoint")
                Log.d("labelWidth" ,"$labelWidth")
                Log.d("totalChartWidth" ,"$totalChartWidth")
                Log.d("amountOfVisibleDataPoints" ,"$amountOfVisibleDataPoints")

                val startIndex = (coin.coinPriceHistory.lastIndex - amountOfVisibleDataPoints)
                    .coerceAtLeast(0)

                Log.d("startIndex" ,"$startIndex")
                Log.d("coin.coinPriceHistory.lastIndex" ,"${coin.coinPriceHistory.lastIndex}")
